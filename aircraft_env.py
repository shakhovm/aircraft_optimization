...
from utils.units_converter import feet2meter, meter2feet, pressure2alt
...
class AircraftEnv:
    ...
    def _load_wind_info(self, file_name="wind.json"):
        ...
        self._wind_magnitude = np.array(winds['wind'])
    ...
    def step(self, action, for_training=True):
        ...
        fuel_flow = self.aicraft.fuel_enroute(30000, tas, altitude, path_angle=0) #*10**2
